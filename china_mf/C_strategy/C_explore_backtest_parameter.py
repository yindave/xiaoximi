...
bt_dump_path=em.path_static_list.replace('static_list.csv','')+'strategy\\bt_dump_for_parameters\\'
...
if __name__ == "__main__":
    ...
    # parallel run
    sizes=[10,20,30,40,50] #4
    benches=['cash_ls']#['CSI300','MSCI_ChinaA','A50','cash','cash_ls'] #4
    min_advs=[5,10,15] #
    p_collector=[]
    for size in sizes:
